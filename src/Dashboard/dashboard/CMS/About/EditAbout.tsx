  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="min-h-screen p-8 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        ...
        <h1 className="text-3xl font-bold mb-8 flex items-center gap-2"><Link to='/dashboard/cms/about' ><ArrowLeftCircle  className='hover:text-[#BA833C]' /></Link>Edit About Page</h1>
          {isLoading ?(
