  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="min-h-screen p-8 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        ...
        <h1 className="text-3xl font-bold mb-8 flex items-center gap-2"><Link to='/dashboard/cms/gallery' ><ArrowLeftCircle  className='hover:text-purple-500' /></Link>Gallery Page Manager</h1>
          {isLoading10 ?(
